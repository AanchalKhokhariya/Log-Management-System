...
@app.route("/")
def home():
    return render_template("main.html", page="first_page")
...
def home1():
    if "user_id" in session:
        ...
        return render_template("demo.html", page="home", name=user.name)
...
def register():
    ...
    try:
        ...
        new_user = User(name=name, gmail=gmail, password=hashed)
